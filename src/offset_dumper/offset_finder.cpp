...
std::map<std::string, DlHandle> load_modules() {
  ...
  static std::array<std::string, 17> const m_modules_path = {
      ...
      "bin/linux64/libtier0_client.so",
      "bin/linux64/libvstdlib_client.so",
      "bin/linux64/libphonon.so",
      "bin/linux64/libv8_libbase.so",
      "bin/linux64/libicuuc.so",
      "bin/linux64/libicui18n.so",
      "bin/linux64/libv8.so",
      "bin/linux64/libavutil.so.54",
      "bin/linux64/libavcodec.so.56",
      "bin/linux64/libavformat.so.56",
      "bin/linux64/libavresample.so.2",
      "bin/linux64/libswscale.so.3",
      "bin/linux64/libvideo.so",
      "csgo/bin/linux64/client_client.so",
      "bin/linux64/libsteamnetworkingsockets.so",
...
int main(int argc, char **argv) {
  ...
  //   return 0;
  // }
  ClientClass cc = load_module("client_client.so");
